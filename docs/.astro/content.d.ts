...
declare module "astro:content" {
	...
	export function render<C extends keyof DataEntryMap>(entry: DataEntryMap[C][string]): Promise<RenderResult>;
	...
	> = L extends { schema: import("astro/zod").ZodSchema } ? import("astro/zod").infer<L["schema"]> : any;
